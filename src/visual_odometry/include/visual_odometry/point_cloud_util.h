...
public:
  ...
  Eigen::MatrixXf cam_T_velo;   // T_velo^cam or cam_T_velo // TODO: rewrite related functions using Eigen::isometry or
                                // Eigen::Transforma; https://eigen.tuxfamily.org/dox/classEigen_1_1Transform.html
  Eigen::MatrixXf rect0_T_cam;  // T_cam0^rect0 or rect0_T_cam0 // NOTE: typedef Transform<float,3,Isometry> Isometry3f
  // P_rect0 3*4 相机的内参
