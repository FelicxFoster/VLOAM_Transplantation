...
void PointCloudUtil::projectPointCloud()
{
  ...
  // std::cout << "point_cloud_3d_front: " << point_cloud_3d_front.rows() << " " << point_cloud_3d_front.cols() << "\n"
  //           << "point_cloud_3d: " << point_cloud_3d.rows() << " " << point_cloud_3d.cols() << "\n";
  int i, j = 0;
  for (i = 0; i < point_cloud_3d.rows(); ++i)
  {
    if (select_front(i))
    {
      ...
      point_cloud_3d_front(j,0) = point_cloud_3d(i,0);
      point_cloud_3d_front(j,1) = point_cloud_3d(i,1);
      point_cloud_3d_front(j,2) = point_cloud_3d(i,2);
      ++j;
    }
  }
